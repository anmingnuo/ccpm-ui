  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="学时" prop="coursePeriod">
        <el-input
          v-model="queryParams.coursePeriod"
          placeholder="请输入学时"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="courseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="学时" align="center" prop="coursePeriod" />
      <el-table-column label="课程类型" align="center" prop="type">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_course_type" :value="scope.row.type"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="学时" prop="coursePeriod">
          <el-input v-model="form.coursePeriod" placeholder="请输入学时" />
        </el-form-item>
        <el-form-item label="课程类型" prop="type">
