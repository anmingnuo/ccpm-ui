<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="教师名字" prop="nickName">
        <el-input
    ...
    <el-table v-loading="loading" :data="teacherList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="教师密码" align="center" prop="password" />
      <el-table-column label="教师名字" align="center" prop="nickName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="教师密码" prop="password">
          <el-input v-model="form.password" placeholder="请输入教师密码" />
        </el-form-item>
        <el-form-item label="教师名字" prop="nickName">
          <el-input v-model="form.nickName" placeholder="请输入教师名字" />
        </el-form-item>
        <el-form-item label="性别" prop="gender">
