  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="班级名称" prop="clazzId">
        <el-select placeholder="请选择班级" v-model="queryParams.clazzId">
          <el-option :label="clazz.clazzName" :value="clazz.id" v-for="(clazz,index) in clazzList"
                     :key="clazz.id"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" :data="studentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="学生密码" align="center" prop="password"/>
      ...
      <el-table-column label="班级名称" align="center" prop="clazz.clazzName"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="学生密码" prop="password">
          <el-input v-model="form.password" placeholder="请输入学生密码"/>
        </el-form-item>
        <el-form-item label="学生姓名" prop="nickName">
...
<script>
import {listStudent, getStudent, delStudent, addStudent, updateStudent, getClazzList} from "@/api/system/student";
